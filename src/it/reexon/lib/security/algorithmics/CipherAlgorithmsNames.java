...
public class CipherAlgorithmsNames
{
     ...
     */
    public static final String PBEWithHmacSHA256AndAES_128 = "PBEWithHmacSHA256AndAES-128";
    ...
    {
        return ListUtils.createList(AES, AES_256, AESWrap_128, AESWrap_192, AESWrap_256, ARCFOUR, Blowfish, DES, DESede, DESedeWrap,
                                    ECIES, PBEWithMD5AndDES, PBEWithHmacSHA256AndAES_128, RC2, RC4, RC5, RSA);
    }
}
