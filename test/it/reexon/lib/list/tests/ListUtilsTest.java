...
public class ListUtilsTest
{
    ...
    public final void testFindEverageElementInt()
    {
        ...
        {
            logger.error("Errore in testFindEverageElementInt", e);
    ...
    public final void testFindEverageElementLong()
    {
        ...
        {
            logger.error("Errore in testFindEverageElementLong", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public final void orderByElementLongTest()
    {
        try
        {
            ...
            try
            {
                ListUtils.orderByElementLong(null, 1L);
                Assert.fail("Should have thrown an exception");
            }
            catch (Exception e)
            {
        ...
        {
            logger.error("Errore in orderByElementLongTest", e);
            throw new RuntimeException(e);
    ...
    public final void nearestElementTest()
    {
        try
        {
            ...
            try
            {
                ListUtils.nearestElement(null, 1L);
                Assert.fail("Should have thrown an exception");
            }
            catch (Exception e)
            {
        ...
        {
            logger.error("Errore in nearestElementTest", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public final void createListTest()
    {
        ...
        {
            logger.error("Errore in createListTest", e);
            throw new RuntimeException(e);
        }
    }
}
